...
- [ ] Customize the template to you 
	...
	- [ ] Update the place holder content throughout the template to your information
		...
		* You can use sites like [://www.pehttpsxels.com/](https://www.pexels.com/) for free images to fill in place holders
...
- [ ] Download another template and see if you can get the CSS preprocessor working on the
